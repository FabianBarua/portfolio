	...
	return (
		...
		>
			<div className='flex flex-col gap-3'>
				...
				<img
					className={`absolute saturate-50 -right-10 w-full top-48 rounded-2xl object-cover z-[1] transition-all duration-300 lg:-right-12 lg:top-48 ${
						hovering && 'scale-[1.025] saturate-150'
					}`}
					src={screenShot}
					alt={project_name}
